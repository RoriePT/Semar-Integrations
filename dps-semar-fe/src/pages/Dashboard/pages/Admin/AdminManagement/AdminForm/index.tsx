...
const AdminForm = ({ opened, handlers, editData, triggerReload }) => {
  const {
    currentTab,
    errorsTab1,
    errorsTab2,
  ...
  const Header = !!editData ? (
    <Title order={4}>Create a new admin</Title>
  ) : (
    <Title order={4}>Update admin</Title>
  );
    ...
    <div>
      <TabsLayout
        ...
        tabs={[
          ...
          { label: "Role & Permissions", value: "2" },
        ]}
        tabPanels={[
          <ProfileTab
            formState={tab1State}
