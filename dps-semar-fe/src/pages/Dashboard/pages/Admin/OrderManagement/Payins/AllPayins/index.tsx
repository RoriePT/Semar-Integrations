...
import PayinCreation from "../../../../../../../components/PayinCreation";
import TableLayout from "../../../../../../../components/TableLayout2";
import usePagination from "../../../../../../../hook/usePagination";
import { formatDateIST } from "../../../../../../../utils";

const AllPayins = ({ reload }) => {
  ...
  return (
    <>
      <TableLayout
        ...
        subtext={
          "View and manage all incoming payment orders initiated by end users."
        }
        showAddBtn={true}
        addBtnText={"Create Payin"}
