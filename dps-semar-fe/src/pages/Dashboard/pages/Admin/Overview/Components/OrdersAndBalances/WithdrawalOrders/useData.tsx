...
const useData = (selectedMerchant) => {
  ...
  const [pieChartData, setPieChartData] = useState([
    { name: "Pending", value: 0, color: "yellow", key: "pending" },
    { name: "Completed", value: 0, color: "green", key: "completed" },
    { name: "Rejected", value: 0, color: "gray", key: "rejected" },
  ...
  const getAllData = async (start = "01/01/2024", end = "12/12/2030") => {
    setLoading(true);
    setLoading2(true);
    const data = await AdminOverviewAPIs.ordersAndBalances.withdrawalOrders({
      startDate: start,
      endDate: end,
    });
