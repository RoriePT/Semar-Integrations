...
export class PayoutController {
  ...
  async getOrderStatusForApiMode(
    ...
    return await this.payoutService.getOrderStatusForApiMode(orderId, +user.id);
  }
}
