...
export class OverviewAdminController {
  ...
  @Post('gateway-upi-vendor-channel-analytics')
  getGatewayUpiVendorChannelAnalytics(@Body() body: FiltersDto) {
    return this.overviewAdminService.getGatewayUpiVendorChannelAnalytics(body);
  }
  ...
  @Post('uniqpay-analytics')
  getUniqpayAnalytics(@Body() body: FiltersDto) {
    return this.overviewAdminService.getUniqpayAnalytics(body);
  }

  @Post('payu-analytics')
  getPayuAnalytics(@Body() body: FiltersDto) {
    return this.overviewAdminService.getPayuAnalytics(body);
  }

  @Post('cashfree-analytics')
  getCashfreeAnalytics(@Body() body: FiltersDto) {
    return this.overviewAdminService.getCashfreeAnalytics(body);
  }
  ...
  @Post('upi-vendor-analytics')
  getUpiVendorAnalytics(@Body() body: FiltersDto) {
    return this.overviewAdminService.getUpiVendorAnalytics(body);
  }

  @Post('settlement-analytics')
  getSettlementAnalytics(@Body() body: FiltersDto) {
    return this.overviewAdminService.getSettlementAnalytics(body);
  }
}
