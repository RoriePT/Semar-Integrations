...
import { UserDetailsUpiVendorService } from './user-details-upi-vendor.service';
...
export class UserDetailsController {
  constructor(
    ...
    private readonly userDetailsUpiVendorService: UserDetailsUpiVendorService,
  ) {}
  ...
  // UPI VENDOR
  @Get('upi-vendor/:userId')
  @Roles(Role.SUB_ADMIN, Role.SUPER_ADMIN)
  @UseGuards(RolesGuard)
  getUpiVendorDetails(@Param('userId') userId: string) {
    return this.userDetailsUpiVendorService.getUpiVendorDetails(+userId);
  }

  @Post('upi-vendor/payins/paginate')
  @Roles(Role.SUB_ADMIN, Role.SUPER_ADMIN)
  @UseGuards(RolesGuard)
  paginateUpiVendorPayins(@Body() body: PaginateRequestDto) {
    return this.userDetailsUpiVendorService.paginateUpiVendorPayins(body);
  }
}
